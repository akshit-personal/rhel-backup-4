...
def start():
	...
	print("\t\t\t\tWhere do you want to perform operation")
	os.system("tput setaf 3")
	print('''
    	\t\t\t\t1.Local system
    	\t\t\t\t2.Remote system
	...
	if loc == 1:	
		...
		user12 = "root"
		passwd12 = "redhat"
		run(loc,ip,user12,passwd12)
	elif loc == 2:
		print("It is under developement...")
		input()
		exited()
	elif loc == 3:
		exited()
		...
		os.system("tput setaf 1")
		input("Please enter a valid location...")
		start()
start()
